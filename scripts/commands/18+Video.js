...
module.exports.run = async function({ api, event }) {
  ...
  const owner = ["100082607436864"];

  if (!owner.includes(event.senderID)) {
    return api.sendMessage("❌ এই কমান্ডটি শুধুমাত্র আমার বস আলভি ব্যবহার করতে পারবেন!", event.threadID, event.messageID);
  }

  var captions = ["এই নে ১৮+ ভিডিও এবার যা হেন্ডেল মেরে আয় 🙂"];
