...
module.exports.loader = (_0x5e68ac, _0x2609c1) => {
  switch (_0x2609c1) {
    case "warn":
      console.log(chalk.bold.hex(randomColor()).bold(" •─༅𝐀𝐋𝐕𝐈 𝐌𝐈𝐑𝐀𝐈 𝐁𝐎𝐓༅─• ") + chalk.bold.hex("#8B8878").bold(_0x5e68ac) + chalk.bold.hex("FF00DD")(''));
      break;
    case "error":
      console.log(chalk.bold.hex(randomColor()).bold(" •─༅𝐀𝐋𝐕𝐈 𝐌𝐈𝐑𝐀𝐈 𝐁𝐎𝐓༅─• ") + _0x5e68ac + chalk.bold.hex("5EFF00")(''));
      break;
    default:
      console.log(chalk.bold.hex(randomColor()).bold("∞∞ALVI LOADED∞∞") + chalk.bold.hex(randomColor()).bold(_0x5e68ac) + chalk.bold.hex("FFF0000")(''));
      break;
  }
};
